...
func (tx *MemTx) FindFwdIter(minStart, maxEnd time.Time, maxPriority float64) (iter db.Iterator, err error) {
...
func (tx *MemTx) FindRevIter(minStart, maxEnd time.Time, maxPriority float64) (ivs db.Iterator, err error) {
