...
func TestConflict(t *testing.T) {
	...
	Ck(err)
	interval1 := NewInterval(start1, end1, 1)
...
func TestEqual(t *testing.T) {
	...
	Ck(err)
	interval1 := NewInterval(start1, end1, 1)
	interval1a := NewInterval(start1, end1, 1)
	...
	Ck(err)
	interval2 := NewInterval(start2, end1, 1)
	...
	Ck(err)
	interval3 := NewInterval(start1, end2, 1)
